...
🌸 **points remarquables** :
- un site web ergonomique, facile a prendre en main et simple d' utilisation
- interface graphique agréable
- Mise en place d'une Map associer a l'adresse du restaurant en question
- utilisation de Link router comme expliquer dans les vidéos
